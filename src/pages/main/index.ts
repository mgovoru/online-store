...
class MainPage extends Page {
	...
	renderMain() {
		...
		if (categoriesReset != null) { categoriesReset.innerText = 'Reset Filters'; }
		if (categoriesCopy != null) { categoriesCopy.innerText = 'Copy Link'; }
		...
		if (categoriesInfo != null) { categoriesSubTitle.innerText = 'Category'; }
